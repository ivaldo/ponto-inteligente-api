...
VALUES (NULL, '82198127000121', CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), 'Kazale IT');
...
VALUES (NULL, '16248890935', CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), 'admin@kazale.com', 'ADMIN', 'ROLE_ADMIN', NULL, NULL, 
